...
//STEP(1)	
	//text field 1
		driver.findElement(By.xpath("(//div[starts-with(@class,'columns-inner')]//child :: textarea)[1]")).sendKeys("Muhammad Idrees Balooch");
	
	//text field 2
		Actions actions = new Actions(driver);
		actions.sendKeys(Keys.PAGE_DOWN).build().perform();
		WebElement textArea2 = driver.findElement(By.xpath("(//div[starts-with(@class,'columns-inner')]//child :: textarea)[2]"));
		Thread.sleep(1);
...
//	//first login
		...
		driver.findElement(By.xpath("(//div[contains(@class,'widget-content')]//descendant :: input )[1]")).sendKeys("Muhammad Iddrees");
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//div[contains(@class,'widget-content')]//descendant :: input )[2]")).sendKeys("8932");
		Thread.sleep(1000);
...
//		actions.moveToElement(frame2).build().perform();
	...
	//2nd login
		driver.findElement(By.xpath("(//form[contains(@name,'login')]//descendant :: input )[1]")).sendKeys("Muhammad Iddrees");
		Thread.sleep(1000);
...
//Step (4):
	...
	//select hyundai	
		...
		Thread.sleep(2000);
	//select doc3
		WebElement dropdown = driver.findElement(By.xpath("(//div[contains(@class,'widget HTML')]//descendant :: select)[2]"));
		dropdown.click();
		Thread.sleep(1000);
		WebElement doc3 = driver.findElement(By.xpath("(//div[contains(@class,'widget-content')]//descendant :: option)[8]"));
		doc3.click();
...
//		actions.click().build().perform();
	...
	//preloaded  textbox	
		...
		WebElement preLoadedText =	driver.findElement(By.xpath("(//div[contains(@class,'sidebar section')]//descendant :: input)[1]"));
		...
		Thread.sleep(1000);
	//enabled button	
		WebElement btn2 = driver.findElement(By.xpath("(//div[contains(@class,'sidebar section')]//descendant :: button)[1]"));
		btn2.click();
...
//        driver.close();
   //     driver.switchTo().window(parentWindowHandler);
	...
	//my btn functionality
		WebElement myBtn = driver.findElement(By.xpath("(//div[contains(@class,'widget-content')]//descendant :: button)[7]"));
	...
	//checkbox	wait
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//div[contains(@class,'sidebar section')]//descendant :: input)[6]")));
	//checkbox click	
...
//Step (5):
	...
	//colors	
		...
		Thread.sleep(1000);
		WebElement readOnlyTextBox = driver.findElement(By.xpath("(//div[contains(@class,'widget HTML')]//descendant :: input)[18]"));
		actions.doubleClick(readOnlyTextBox).perform();
		Thread.sleep(2000);
		
	//get Prompt for name xxxxxxxxxxxxxxxxxxxxxxxxxx	
		
        WebElement getPrompt = driver.findElement(By.xpath("(//div[contains(@class,'widget HTML')]//descendant :: input)[19]"));
		getPrompt.click();
...
//		getPromptAlert.accept();
	...
	//filling text boexs and selecting car
		...
		//Thread.sleep(1000);
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//div[contains(@class,'widget-content') ]//descendant :: a)[20]")));
